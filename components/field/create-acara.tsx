...
import { FormCreateAcara, formCreateAcara } from "@/schemas";
...
import { createAcara } from "@/lib/action";
...
export const CreateAcaraField = ({
  ...
  const form = useForm({
    ...
    validators: { onSubmit: formCreateAcara },
    onSubmit: async ({ value }: { value: FormCreateAcara }) => {
      onLoading(true);
